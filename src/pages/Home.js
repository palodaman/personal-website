...
export default function Home(){
    ...
    <div className="home"> 
        ...
        <div className="description">
          ...
          <p>Whenever I am not programming, I am usually gaming on my steam deck, reading, jamming with my ukulele, lost online in the depths of technical documentation and tech conferences, or spending some recreational time in the nature. Special mention to restocking the costly groceries (plight of an international student).</p>
